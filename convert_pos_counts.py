...
def convert_pos_to_counts(dataframe):
    ...
    columns = ['item_id', 'subject_id',	'modality',  'ADJ', 'ADP', 'ADV', 'AUX', 'CONJ', 'CCONJ', 'DET', 'INTJ', 'NOUN', 'NUM', 'PART', 'PRON', 'PROPN', 'PUNCT', 'SCONJ', 'SYM', 'VERB', 'X', 'EOL', 'SPACE']
    ...
    for i, datapoint in dataframe.iterrows():
        if datapoint["aligned_edit"] != "nan":
            ...
            array = [datapoint["item_id"], datapoint["subject_id"], datapoint["modality"]] + [0] * 20
            for key in pos_dict:
