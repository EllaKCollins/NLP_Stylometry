...
import string, re, joblib, os, sys
...
def it_tfidf(text):
    file = 'tfidf_italian.joblib'
    if not os.path.exists(file):
        print("The TF-IDF vectorizer does not exist; please run 'tfidf_generate.py' before this script")
        sys.exit()
...
def test_subject_preprocessed_dataset():
